...
class ShowHistogramButtonComponent(ttk.Button):
  ...
  def _configure_styles(self):
    ...
    """
    style = ttk.Style()
    style.configure("Histogram.TButton", font=("Helvetica", 10), background="#E5E5E5", foreground="#111111", borderwidth=1)
    style.map("Histogram.TButton", background=[('active', '#D5D5D5')], foreground=[('active', '#000000')])
