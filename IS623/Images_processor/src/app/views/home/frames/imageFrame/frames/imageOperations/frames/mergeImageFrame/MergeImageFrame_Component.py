...
class MergeImageFrameComponent(ttk.Frame):
  ...
  def _configure_frame(self):
    ...
    self.place(relx=0.5, rely=0.8, relwidth=2, relheight=0.1, anchor="n")
  ...
  def _on_resize(self, _):
    ...
    """
    self.place_configure(relx=0.5, rely=0.8, relwidth=2, relheight=0.1, anchor="n")
