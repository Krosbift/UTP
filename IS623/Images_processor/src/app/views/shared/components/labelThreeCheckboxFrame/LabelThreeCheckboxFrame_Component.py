...
class LabelThreeCheckboxFrameComponent(ttk.Frame):
  ...
  def _configure_frame(self):
    ...
    self.place(relx=self.relx, rely=self.rely, relwidth=2, relheight=0.12, anchor="n")
  ...
  def _on_resize(self, _):
    ...
    """
    self.place_configure(relx=self.relx, rely=self.rely, relwidth=2, relheight=0.12, anchor="n")
