...
public class MinimalPanelComponent extends JPanel implements ComponentInterface {
  public MinimalPanelController controller;

  public MinimalPanelComponent(MinimalPanelController controller) {
